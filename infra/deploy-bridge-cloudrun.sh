...
# min-instances=1 restaurado por decisão do dono (24/08/2026): entrou em
# produção, cold start deixa de ser aceitável -- 4,7s medido em GET /health
# (achado 23/08/2026). Bridge está no caminho de toda mensagem de saída
# real (Chatwoot -> Agent Bot -> bridge -> provedor) -- documentado na
# skill `agentllm` (personal-skills). Confirmado antes de editar: este é o
